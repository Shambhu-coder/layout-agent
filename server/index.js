...
app.listen(PORT, () => {
  ...
  if (!process.env.OPENROUTER_API_KEY) {
    console.warn('⚠️  OPENROUTER_API_KEY not set. Get your free key at https://openrouter.ai/keys');
  } else {
    console.log('✅ Model: google/gemini-2.0-flash-exp:free via OpenRouter (FREE)');
  }
  console.log('\nEndpoints:');
